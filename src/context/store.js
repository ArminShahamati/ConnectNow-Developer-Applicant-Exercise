...
const initialState = { mainData: [], showData: [],sortRange:true,sortValue:'first_release_date' }
    ...
    case 'sortData':
      ...
      switch (fieldData) {
        ...
        case 'first_release_date':
          state.sortRange ?
            sortFilteredData = sortFullData.slice().sort((a, b) => a.first_release_date - b.first_release_date) :
            sortFilteredData = sortFullData.slice().sort((a, b) => b.first_release_date - a.first_release_date);
          break;
        case 'rating':
          state.sortRange ?
         sortFilteredData = sortFullData.slice().sort((a, b) => a.rating - b.rating):
            sortFilteredData = sortFullData.slice().sort((a, b) => b.rating - a.rating);
            break;
      }
